...
def train_baseline_model():
    print("--- Starting to train baseline model (Experiment A) ---")
...
def train_robust_model():
    print("\n--- Starting to train robust model (Experiment D) ---")
    device = 'cuda' if torch.cuda.is_available() else 'cpu'
    model = YOLO(PRETRAINED_MODEL)
...
if __name__ == '__main__':
    ...
    train_robust_model()
    print(f"\nAll training tasks have been completed! Models are saved in: {MODEL_SAVE_DIR}")
