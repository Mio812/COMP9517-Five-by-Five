...
try:
    ...
    print("Warning: Could not import CBAM module, using standard YOLO model")
...
def create_baseline_performance_chart(full_report, save_dir):
    ...
    plt.close()
    print("  Baseline performance chart created.")
...
def create_robustness_comparison_chart(full_report, save_dir):
    ...
    plt.close()
    print("  Robustness comparison chart created.")
...
def create_performance_drop_chart(full_report, save_dir):
    ...
    plt.close()
    print("  Performance drop chart created.")
...
def create_comprehensive_comparison(full_report, save_dir):
    ...
    plt.close()
    print("  Comprehensive comparison chart created.")
...
def create_distortion_examples(original_test_images_path, save_dir):
    ...
    plt.close()
    print("  Distortion examples chart created.")
...
def create_timing_visualization(full_report, save_dir):
    ...
    plt.close()
    print("  Timing analysis chart created.")
...
def main():
    ...
    try:
        ...
        if 'test' in data_config:
            ...
            print(f"Test set path from YAML: {test_path_from_yaml}")
            
            print("\nIntelligently resolving test set path...")
            ...
            if original_test_images_path:
                ...
                if os.path.exists(original_test_images_path):
                    ...
                    if original_labels_path:
                        ...
                        print(f"Warning: Label directory not found")
                else:
                    print(f"Error: Resolved path still does not exist")
                    return
            else:
                print(f"Error: Could not find test set")
                return
        else:
    ...
    try:
        ...
        print(f"Using temporary config file: {temp_yaml_path}")
    ...
    print(f"  - Testing inference time on {num_images} images...")
    ...
    print(f"  - Robustness Tests: {len(robustness_results)} distortions")
